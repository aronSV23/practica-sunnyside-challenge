...
export const Texts = ({ order, title, text, color }) => {
    return (
        <div className={`text-center h-[437px] px-6 flex flex-col place-content-around py-6 tablet:h-auto ${order} lg:px-[65px] desktop:text-left desktop:pl-[165px] desktop:py-[140px] desktop:pr-[105px]`}>
